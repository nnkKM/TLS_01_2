    ...
    if (map.getLayer('population-fill-layer')) {
        map.setPaintProperty('population-fill-layer', 'fill-color', [
            ...
            [
                ...
                ["<=", ["get", `POP_${year}`], aSmallpop[0]*n]   , "rgb(245, 227, 227)",
                ["<=", ["get", `POP_${year}`], aSmallpop[0]*n**2], "rgb(235, 198, 198)",
                ["<=", ["get", `POP_${year}`], aSmallpop[0]*n**3], "rgb(235, 170, 170)",
                ["<=", ["get", `POP_${year}`], aSmallpop[0]*n**4], "rgb(235, 142, 142)",
                ["<=", ["get", `POP_${year}`], aSmallpop[0]*n**5], "rgb(235, 113, 113)",
                ["<=", ["get", `POP_${year}`], aSmallpop[0]*n**6], "rgb(235, 85, 85)",
                ["<=", ["get", `POP_${year}`], aSmallpop[0]*n**7], "rgb(235, 57, 57)",
                ["<=", ["get", `POP_${year}`], aSmallpop[0]*n**8], "rgb(235, 28, 28)",
                "rgb(255, 0, 0)"
            ],
            6, [
                "case",
                ["<=", ["get", `POP_${year}`], aSmallpop[1]]     , "rgb(255, 255, 255)",
                ["<=", ["get", `POP_${year}`], aSmallpop[1]*n]   , "rgb(245, 227, 227)",
                ["<=", ["get", `POP_${year}`], aSmallpop[1]*n**2], "rgb(235, 198, 198)",
                ["<=", ["get", `POP_${year}`], aSmallpop[1]*n**3], "rgb(235, 170, 170)",
                ["<=", ["get", `POP_${year}`], aSmallpop[1]*n**4], "rgb(235, 142, 142)",
                ["<=", ["get", `POP_${year}`], aSmallpop[1]*n**5], "rgb(235, 113, 113)",
                ["<=", ["get", `POP_${year}`], aSmallpop[1]*n**6], "rgb(235, 85, 85)",
                ["<=", ["get", `POP_${year}`], aSmallpop[1]*n**7], "rgb(235, 57, 57)",
                ["<=", ["get", `POP_${year}`], aSmallpop[1]*n**8], "rgb(235, 28, 28)",
                "rgb(235, 0, 0)"
            ],
            8, [
                "case",
                ["<=", ["get", `POP_${year}`], aSmallpop[2]]     , "rgb(255, 255, 255)",
                ["<=", ["get", `POP_${year}`], aSmallpop[2]*n]   , "rgb(245, 227, 227)",
                ["<=", ["get", `POP_${year}`], aSmallpop[2]*n**2], "rgb(235, 198, 198)",
                ["<=", ["get", `POP_${year}`], aSmallpop[2]*n**3], "rgb(235, 170, 170)",
                ["<=", ["get", `POP_${year}`], aSmallpop[2]*n**4], "rgb(235, 142, 142)",
                ["<=", ["get", `POP_${year}`], aSmallpop[2]*n**5], "rgb(235, 113, 113)",
                ["<=", ["get", `POP_${year}`], aSmallpop[2]*n**6], "rgb(235, 85, 85)",
                ["<=", ["get", `POP_${year}`], aSmallpop[2]*n**7], "rgb(235, 57, 57)",
                ["<=", ["get", `POP_${year}`], aSmallpop[2]*n**8], "rgb(235, 28, 28)",
                "rgb(235, 0, 0)"
            ],
            10, [
                "case",
                ["<=", ["get", `POP_${year}`], aSmallpop[3]]     , "rgb(255, 255, 255)",
                ["<=", ["get", `POP_${year}`], aSmallpop[3]*n]   , "rgb(245, 227, 227)",
                ["<=", ["get", `POP_${year}`], aSmallpop[3]*n**2], "rgb(235, 198, 198)",
                ["<=", ["get", `POP_${year}`], aSmallpop[3]*n**3], "rgb(235, 170, 170)",
                ["<=", ["get", `POP_${year}`], aSmallpop[3]*n**4], "rgb(235, 142, 142)",
                ["<=", ["get", `POP_${year}`], aSmallpop[3]*n**5], "rgb(235, 113, 113)",
                ["<=", ["get", `POP_${year}`], aSmallpop[3]*n**6], "rgb(235, 85, 85)",
                ["<=", ["get", `POP_${year}`], aSmallpop[3]*n**7], "rgb(235, 57, 57)",
                ["<=", ["get", `POP_${year}`], aSmallpop[3]*n**8], "rgb(235, 28, 28)",
                "rgb(235, 0, 0)"
            ],
            12, [
                "case",
                ["<=", ["get", `POP_${year}`], aSmallpop[4]]     , "rgb(255, 255, 255)",
                ["<=", ["get", `POP_${year}`], aSmallpop[4]*n]   , "rgb(245, 227, 227)",
                ["<=", ["get", `POP_${year}`], aSmallpop[4]*n**2], "rgb(235, 198, 198)",
                ["<=", ["get", `POP_${year}`], aSmallpop[4]*n**3], "rgb(235, 170, 170)",
                ["<=", ["get", `POP_${year}`], aSmallpop[4]*n**4], "rgb(235, 142, 142)",
                ["<=", ["get", `POP_${year}`], aSmallpop[4]*n**5], "rgb(235, 113, 113)",
                ["<=", ["get", `POP_${year}`], aSmallpop[4]*n**6], "rgb(235, 85, 85)",
                ["<=", ["get", `POP_${year}`], aSmallpop[4]*n**7], "rgb(235, 57, 57)",
                ["<=", ["get", `POP_${year}`], aSmallpop[4]*n**8], "rgb(235, 28, 28)",
                "rgb(235, 0, 0)"
            ]
        ]);
    }
